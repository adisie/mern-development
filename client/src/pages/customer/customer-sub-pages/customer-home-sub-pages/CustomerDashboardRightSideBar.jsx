...
const CustomerDashboardRightSideBar = () => {
  return (
    <div className="p-[1%] pb-0 pr-0 min-w-[250px]">
      <div className="w-full h-full rounded-md shadow-lg px-[5%]">
          ...
          <div className="bg-gray-200 rounded-md p-[5%] mt-3">
            ...
            <div className="grid grid-cols-7 gap-0">
                <div className="flex flex-col items-center gap-y-3">
                    <div><h3>M</h3></div>
                    <div><span className="font-bold text-gray-600">12</span></div>
                </div>
                <div className="flex flex-col items-center rounded-full text-white gap-y-3 bg-blue-950">
                    <div><h3>T</h3></div>
                    <div className="bg-emerald-700 mb-1 px-1 rounded-full"><span className="font-medium text-sm">13</span></div>
                </div>
                <div className="flex flex-col items-center gap-y-3">
                    <div><h3>W</h3></div>
                    <div><span className="font-bold text-gray-600">14</span></div>
                </div>
                <div className="flex flex-col items-center gap-y-3">
                    <div><h3>T</h3></div>
                    <div><span className="font-bold text-gray-600">15</span></div>
                </div>
                <div className="flex flex-col items-center gap-y-3">
                    <div><h3>F</h3></div>
                    <div><span className="font-bold text-gray-600">16</span></div>
                </div>
                <div className="flex flex-col items-center gap-y-3">
                    <div><h3>S</h3></div>
                    <div><span className="font-bold text-gray-600">17</span></div>
                </div>
                <div className="flex flex-col items-center gap-y-3">
                    <div><h3>S</h3></div>
                    <div><span className="font-bold text-gray-600">18</span></div>
                </div>
        ...
        <div className="mt-5 border border-black border-opacity-15 rounded-md border-r-transparent border-b-transparent">
            <div className="p-2">
                ...
                <div className="flex items-center justify-between mt-2 pb-3 border-b border-gray-200">
                    <button className="px-[10%] py-[.13rem] rounded-sm text-white bg-yellow-600">Request</button>
                    <button className="px-[10%] py-[.13rem] rounded-sm text-white bg-yellow-600">Transfer</button>
                </div>
            </div>
            <div>
                <div className="p-2">
                    <header className="flex items-center justify-between">
                        <div>
                            <h3 className="text-sm font-bold text-gray-700">Expense Analysis</h3>
                        </div>
                        <div>
                            ...
                            <MdOutlineKeyboardArrowDown className="text-lg"/></button>
                        </div>
                    </header>
                    <div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex-grow text-sm text-gray-500 pb-1 border-b-4 border-purple-800">
                            ...
                            <div className="text-xs font-semibold text-gray-700">$23,100.00</div>
                        </div>
